...
- Babel Documentation:
  ...
  - [[https://emacs.stackexchange.com/questions/3143/can-i-use-org-mode-to-structure-my-emacs-or-other-el-configuration-file][Example configuration]]
* TABLE OF CONTENTS
- I use "[[https://github.com/alphapapa/org-make-toc][org-make-toc]]" to make GitHub friendly ToCs.
  - After changes, update with =org-make-toc=.
:PROPERTIES:
:TOC:      :include all :ignore this
:END:
:CONTENTS:
- [[#babel-readme][BABEL README]]
- [[#packages][PACKAGES]]
- [[#emacs-settings][EMACS SETTINGS]]
  ...
  - [[#programming-hooks][Programming hooks]]
  - [[#xml-hooks][XML hooks]]
- [[#writing][WRITING]]
  - [[#spelling][Spelling]]
  ...
  - [[#hooks-for-writing][Hooks for writing]]
...
- [[#elfeed-rss][ELFEED RSS]]
  ...
  - [[#fix-for-use-with-olivetti][Fix for use with olivetti]]
- [[#latex][LATEX]]
- [[#added-by-emacs][ADDED BY EMACS]]
:END:
...
(setq synosaurus-choose-method 'popup
      ...
      ispell-personal-dictionary "~/my-files/org/org-roam/emacs/ispell-personal-dictionary"
      ispell-silently-savep t
      ispell-dictionary "en_US"

      abbrev-file-name "~/my-files/org/org-roam/emacs/abbrev_defs/abbrev_defs"
...
#+begin_src elisp
  (add-to-list 'load-path "~/my-files/org/org-roam/emacs/.emacs.d/my-packages/auto-capitalize-el/")
...
* KEYBINDINGS
** General
- =free-keys= to find unused bindings
#+begin_src elisp
...
#+end_src
** Multiple cursors
- Based on "https://www.youtube.com/watch?v=mDDeSKRc3Zo"
- If issue with org-mode, delete ".mc-lists.el" and follow prompt
...
** Zoom
#+begin_src elisp
  (add-to-list 'load-path "~/my-files/org/org-roam/emacs/.emacs.d/my-packages/zoom-frm/")
  (require 'zoom-frm)
#+end_src
...
* ORG-MODE
** Ox-extras
- =ox-bibtex= loaded before =org-ref=.
#+begin_src elisp
  (require 'ox-extra)
  (require 'ox-latex)
  (require 'ox-bibtex)
...
- Activate =:ignore:= tag for export
#+begin_src elisp
  (ox-extras-activate
   '(ignore-headlines))
#+end_src
...
#+begin_src elisp
  (setq org-directory "~/my-files/org"
        ...
        org-tags-column 0
        org-ellipsis " ⤾"
        org-archive-location "~/my-files/org/org-archive/org-archive-global.org::* From %s"
...
#+begin_src elisp
  (setq org-capture-templates '(("n" "note-at-point" plain (file "") " - (%^{location}) Here it says that %^{Here it says that...}.")
                                ...
                                ("t" "scheduled-todo" entry (file+headline "~/my-files/org/org-roam/todo/todo.org" "TASK-INDEX") (file "~/my-files/org/org-templates/scheduled-todo-basic"))
                                ("T" "scheduled-todo-full" entry (file+headline "~/my-files/org/org-roam/todo/todo.org" "TASK-INDEX") (file "~/my-files/org/org-templates/scheduled-todo-with-deadline"))
                                ("r" "rss todo" entry (file+olp "~/my-files/org/org-roam/todo/todo.org" "TASK-INDEX") "* TODO %^{Description} %^g:RSS:\nSCHEDULED: %^t\n\n %a\n\n %i")))
#+end_src

- Capture at point (for notes)
#+begin_src elisp
...
- Requires =org-ml=
#+begin_src elisp
  (add-to-list 'load-path "~/my-files/org/org-roam/emacs/.emacs.d/my-packages/org-to-xml")
  (require 'om-to-xml)
#+end_src
...
#+begin_src elisp
  ...
  (add-hook 'after-save-hook #'(lambda ()
                                 (if (string= (buffer-file-name)
                                              (concat (getenv "HOME") "/my-files/org/org-roam/todo/todo.org"))
                                     (my-org-agenda-to-appt))))
